...
# load the image and compute the ratio of the old height to the new height, clone it,
# and resize it
...
# find the contours in the edged image, keeping only the largest ones, and
